...
<head>
<meta charset="UTF-8">
<title>Daniel Dolar Sarumaha - Pro SPA</title>
<style>
...
.sidebar{width:220px;background:#11112a;padding:20px;display:flex;flex-direction:column;}
...
.main{flex:1;overflow-y:auto;padding:20px;background:linear-gradient(135deg,#1b1b2f,#0e0e20);}
